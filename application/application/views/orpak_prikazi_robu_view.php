...
$add="<img style='width:100px; height:100px' src='https://images.all-free-download.com/images/graphiclarge/sign_add_88771.jpg'>";
  echo "<td><a href='http://mihgaj8.freehostia.com/codeigniter/index.php/orpak_ctrl/unos_slike/".$row->id."'><button style='cursor:pointer'>".$add."Dodaj sliku</button></a></td>";
  ...
  echo "<td><a href='http://mihgaj8.freehostia.com/codeigniter/index.php/orpak_ctrl/brisanje_robe/".$row->id."'><button style='cursor:pointer'>".$del."Delete</button></a></td>";
  ...
  echo "<td><a href='http://mihgaj8.freehostia.com/codeigniter/index.php/orpak_ctrl/azuriranje_robe/".$row->id."'><button style='cursor:pointer'>".$upd."Update</button></a></td>";
  ...
  echo "<td><a href='http://mihgaj8.freehostia.com/codeigniter/index.php/orpak_ctrl/detaljan_prikaz_robe/".$row->id."'><button style='cursor:pointer'>".$det."Detaljno</button></a></td>";
