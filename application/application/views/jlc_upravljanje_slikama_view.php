...
<body><span style="position:relative;top:-100px;">Upravljanje dodatnim slikama </span>
...
//  echo "<td>".$i."</td>";
  ...
  echo "<td><a href='unos_slike/".$row->id_artikla."'>Dodaj sliku</a></td>";
  echo "<td><a href='brisi_sliku/".$row->id."'>Izbrisi sliku</a></td>";
