...
<form method="post">
  ...
  <textarea  cols="35" rows="1" name="dugi_opis" onkeyup="textAreaAdjust(this)" style="overflow:hidden">
     ...
     <tr>
   	...
   	<td>
   		<table><tr><td>Unesite URL slike sa interneta :<img id="slika" src='' style="width:360px; height:300px;position:relative;top:10px;" ><input type="text" style="width:360px;position:relative;top:10px;left:-5px;margin:5px 5px;"  ondblclick="getElementById('link_slike').value=''"  onblur="getElementById('slika').src=this.value;" id="link_slike" name="link_slike"/></td><td><iframe id="ifrm1" src="https://true-born-initials.000webhostapp.com/upload_file.php" ></iframe></td></tr></table>
