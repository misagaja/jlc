  			...
  			<ul>
    				...
    				<li style="position:relative;float:left;"><a href="#" aria-haspopup="true">Shoping</a>
    					<ul class="dropdown" aria-label="submenu">
    						...
    						<!--<a href="http://mihgaj8.freehostia.com/codeigniter/index.php/jlc_ctrl/proba"><li>Shoping</li></a>-->
    					</ul>
    				</li>
<?
...
?> 	
				<a href="http://mihgaj8.freehostia.com/codeigniter/index.php/jlc_ctrl/updatedata/<? echo $user;?>"><img class='magnify' src='<? echo $avatar?>' style='width:55px; height:55px;border-radius:50%;position:relative;float:right;'></a>
   				...
   				<a  href="http://mihgaj8.freehostia.com/codeigniter/index.php/jlc_ctrl/odjavi"><li style="position:relative;float:right;">Logout</li></a>
    				<li style="position:relative;float:right;"><a href="#" aria-haspopup="true">My shop</a>
      					<ul class="dropdown" aria-label="submenu">
...
{
?>
     				<li style="position:relative;float:right;"><a href="http://mihgaj8.freehostia.com/codeigniter/index.php/jlc_ctrl/upis_prijave">Login</a></li>
     				<li style="position:relative;float:right;"><a href="http://mihgaj8.freehostia.com/codeigniter/index.php/jlc_ctrl/registracija">Register</a></li>
<?
}
if($user=="admin"){
?>
...
<br>
<? if($user<>"admin"){?>
    <div id="pozdrav" class="w3-container w3-col s6 m6 l6" style="position:relative;top:200px;left:300px;color:blue;z-index:10;">Welcome to Your JLC shop!!!</div>
 <?}?>   
</div> 

<div class="w3-container" id="pretraga" style="height:50px;">
 	<form id="k" method='post' style="position:relative;top:5px;">
 	<span style="background-color:white;"><span>Unesite deo naziva artikla</span>
